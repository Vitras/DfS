	...
	void OnGUI ()
	{
		if (Network.peerType == NetworkPeerType.Disconnected) {
			...
			if (Network.peerType == NetworkPeerType.Client) {
				...
				if (GUI.Button (new Rect (100, 150, 150, 25), "Make cube white"))
					SendCommandToServer ("0");

				if (GUI.Button (new Rect (100, 150, 150, 25), "Make cube red"))
					SendCommandToServer ("1");

				if (GUI.Button (new Rect (100, 150, 150, 25), "Make cube blue"))
					SendCommandToServer ("2");

				if (GUI.Button (new Rect (100, 150, 150, 25), "Make cube black"))
